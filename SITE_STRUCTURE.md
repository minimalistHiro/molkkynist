...
- Instagram DM へのリンク
- お問い合わせフォーム（必須: 名前・メール／任意: 電話番号・住所／用件区分: 参加希望・イベント問い合わせ・メディア取材・その他／一言／参加希望時は Firestore `events` から取得した開催日程をトグル選択）
...
- 各イベントカードに参加人数を表示
- イベント選択後、そのイベントの参加者一覧を表示
- 参加者一覧には、名前、メールアドレス、電話番号、住所、一言・ご質問、対応ステータスを表示
