...
- 参加者情報は、既存フォームで取得済みの名前、メールアドレス、電話番号、一言、申込日時を表示対象にする。
- 住所取得は現行実装には含めない。
...
- 開いた時だけ、メールアドレス、電話番号、一言・ご質問、申込日時を表示する。
...
- 参加者名右側のくの字型ボタンで、メールアドレス、電話番号、一言、申込日時を開閉表示できること。
...
- 各ユーザー名の右側にくの字型の開閉ボタンを置き、開いた時だけメールアドレス、電話番号、一言・ご質問、申込日時を表示する構成にした。
