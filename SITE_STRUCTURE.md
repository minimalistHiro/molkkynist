...
- フッター直前のSNS導線（緑背景に `follow us` ラベル、公式Instagramリンク、X / LINE の仮リンクを置く。大きな参加見出し、説明文、フォーム申込ボタンは置かない）
...
- スマートフォンでは右上のハンバーガーボタンから、`モルックとは`、`次回イベント`、`参加の流れ`、`活動の様子`、`メンバー`、`よくある質問`、`参加・お問い合わせ` を縦並びで表示する。
